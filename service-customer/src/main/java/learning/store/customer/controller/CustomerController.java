package learning.store.customer.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import learning.store.customer.entity.Customer;
import learning.store.customer.entity.Region;
import learning.store.customer.service.CustomerServiceImpl;
import learning.store.customer.service.ICustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<List<Customer>> listAllCustomer (@RequestParam(name = "regionId",required = false) Long regionId){
        ...
        if(null == regionId){
            ...
            customerService.findCustomersByRegion(region);
            if(null==customers){
